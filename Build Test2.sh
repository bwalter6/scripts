...
Build() { 
    ...
    mkdir /tmp/build
    mount -t smbfs -o nobrowse //"$zID":"$encoded_password"@dfw1mspif017.nao.global.gmacfs.com/public/mac/Build /tmp/build
    cd /tmp/build/
    ./NetworkSSHKey.sh
...
# # #Copy and Install PMA.pkg (Manual)
# # # mkdir /tmp/pma/
...
Get_policies()  {
    ...
    echo
    echo
    echo "Checking for Policy Updates, this may take several minutes..."
...
echo
echo
echo "Setup Complete. Preparing to Reboot..."
